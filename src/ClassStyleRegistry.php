...
final class ClassStyleRegistry {
	...
	/**
	 * Require an exact component Class Style Reference without mutating styles.
	 *
	 ...
	 * and the referenced style must own exactly one simple class selector.
	 *
	...
	public static function require_registered_class_style_id( string $style_id ): string {
		return ClassStyleReference::registered( $style_id )->id();
	}
